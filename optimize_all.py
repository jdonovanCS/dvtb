...
for layer_name in net1._layer_names:
    ...
    if (layer_name in ['conv1/7x7_s2', 'conv2/3x3_reduce', 'conv2/3x3', 'inception_3a/1x1', 'inception_3a/3x3', 'inception_3a/3x3_reduce', 'inception_3a/5x5_reduce', 'inception_3a/5x5', 'inception_3a/pool_proj',
                        ...
                        'inception_4b/5x5', 'inception_4b/pool_proj', 'inception_4c/1x1', 'inception_4c/3x3_reduce', 'inception_4c/5x5', 'inception_4d/5x5', 'inception_4e/5x5', 'inception_5a/5x5'] 
                        or '5x5' not in layer_name or 'reduce' in layer_name):
        continue
    node_count = 0
    if layer_name == 'inception_5b/5x5':
        node_count = 127
