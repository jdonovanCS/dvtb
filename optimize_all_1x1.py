...
for layer_name in net1._layer_names:
    ...
    if (layer_name in ['conv1/7x7_s2', 'conv2/3x3_reduce', 'conv2/3x3', 'inception_3a/1x1', 'inception_3a/3x3', 'inception_3a/3x3_reduce', 'inception_3a/5x5_reduce', 'inception_3a/5x5', 'inception_3a/pool_proj',
                        ...
                        'inception_4b/5x5', 'inception_4b/pool_proj', 'inception_4c/3x3_reduce', 'inception_4d/1x1', 'inception_4c/1x1', 'inception_4e/1x1', 'inception_5a/1x1', 'inception_5b/1x1']
                         or '1x1' not in layer_name or 'reduce' in layer_name):
        continue
    node_count = 0
    # if layer_name == 'inception_4e/1x1':
    #     node_count = 
