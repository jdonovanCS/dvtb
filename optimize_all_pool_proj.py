...
for layer_name in net1._layer_names:
    ...
    if (layer_name in ['conv1/7x7_s2', 'conv2/3x3_reduce', 'conv2/3x3', 'inception_3a/1x1', 'inception_3a/3x3', 'inception_3a/3x3_reduce', 'inception_3a/5x5_reduce', 'inception_3a/5x5', 'inception_3a/pool_proj',
                        ...
                        'inception_4b/5x5', 'inception_4b/pool_proj', 'inception_4c/1x1', 'inception_4c/3x3_reduce', 'inception_4c/pool_proj', 'inception_4d/pool_proj', 'inception_4e/pool_proj', 'inception_5a/pool_proj'] 
                        or 'pool_proj' not in layer_name or 'reduce' in layer_name):
        continue
    node_count = 0
    if layer_name == 'inception_5b/pool_proj':
        node_count = 127
